...
/**
 * Valida el JWT localmente con la SECRET_KEY compartida con el servicio auth (HS256).
 * No hace request al auth en cada llamada: en un monolito alcanza con verificar la firma.
